...
class TeslaFleetClient:
    ...
    # Vehicle commands. These calls never wake a vehicle and never retry a write.

    def actuate_trunk(
        self, access_token: str, *, base_url: str, vin: str, request: ActuateTrunkRequest
    ) -> CommandResult:
        return self._command(access_token, base_url, vin, "actuate_trunk", request)

    def add_charge_schedule(
        self, access_token: str, *, base_url: str, vin: str, request: ChargeScheduleRequest
    ) -> CommandResult:
        return self._command(access_token, base_url, vin, "add_charge_schedule", request)

    def add_precondition_schedule(
        self, access_token: str, *, base_url: str, vin: str, request: PreconditionScheduleRequest
    ) -> CommandResult:
        return self._command(access_token, base_url, vin, "add_precondition_schedule", request)

    def adjust_volume(
        self, access_token: str, *, base_url: str, vin: str, request: AdjustVolumeRequest
    ) -> CommandResult:
    ...
    def guest_mode(
        self, access_token: str, *, base_url: str, vin: str, request: EnableRequest
    ) -> CommandResult:
    ...
    def parental_controls_enable_setting(
        self, access_token: str, *, base_url: str, vin: str, request: ParentalSettingRequest
    ) -> CommandResult:
    ...
    def parental_controls_set_speed_limit(
        self, access_token: str, *, base_url: str, vin: str, request: SpeedLimitRequest
    ) -> CommandResult:
        return self._command(
    ...
    def remote_auto_seat_climate_request(
        self, access_token: str, *, base_url: str, vin: str, request: AutoSeatClimateRequest
    ) -> CommandResult:
        return self._command(
    ...
    def remote_auto_steering_wheel_heat_climate_request(
        self, access_token: str, *, base_url: str, vin: str, request: BoolRequest
    ) -> CommandResult:
        return self._command(
    ...
    def remote_steering_wheel_heat_level_request(
        self, access_token: str, *, base_url: str, vin: str, request: LevelRequest
    ) -> CommandResult:
        return self._command(
    ...
    def remove_charge_schedule(
        self, access_token: str, *, base_url: str, vin: str, request: ScheduleIDRequest
    ) -> CommandResult:
    ...
    def set_cop_temp(
        ...
        *,
        base_url: str,
        vin: str,
        request: CabinOverheatTemperatureRequest,
    ) -> CommandResult:
        return self._command(access_token, base_url, vin, "set_cop_temp", request)

    def set_pin_to_drive(
        self, access_token: str, *, base_url: str, vin: str, request: SetPinRequest
    ) -> CommandResult:
    ...
    def set_scheduled_charging(
        self, access_token: str, *, base_url: str, vin: str, request: ScheduledChargingRequest
    ) -> CommandResult:
    ...
    def set_scheduled_departure(
        self, access_token: str, *, base_url: str, vin: str, request: ScheduledDepartureRequest
    ) -> CommandResult:
    ...
    def set_temps(
        self, access_token: str, *, base_url: str, vin: str, request: TemperatureRequest
    ) -> CommandResult:
    ...
    def set_vehicle_name(
        self, access_token: str, *, base_url: str, vin: str, request: VehicleNameRequest
    ) -> CommandResult:
    ...
    def _command(
        ...
        document = self._request_json(
            "POST",
            base_url,
            _vehicle_path(vin, f"command/{name}"),
            access_token,
        ...
        if not isinstance(result, bool):
            raise TeslaAPIError(
                "Tesla command response is missing result",
                category="invalid_payload",
            )
